...
options = {
    ...
    series: [{name: "High - 2018", data: [28, 29, 33, 36, 32, 32, 33]}, {
        name: "Low - 2018",
...
function generateDayWiseTimeSeries(e, t, a) {
    for (var r = 0, o = []; r < t;) {
        var n = e, i = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
...
function getDayWiseTimeSeries(e, t, a) {
    for (var r = 0; r < t;) {
        ...
        data.push({x: o, y: n}), lastDate = e, e += 864e5, r++
    }
}
