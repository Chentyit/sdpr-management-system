$(document).ready(function () {
    ...
    $("#products-datatable").DataTable({
        language: {
            ...
            lengthMenu: 'Display <select class=\'custom-select custom-select-sm ml-1 mr-1\'><option value="10">10</option><option value="30">30</option><option value="40">40</option><option value="-1">All</option></select> products'
        },
        pageLength: 10,
        columns: [
            {
