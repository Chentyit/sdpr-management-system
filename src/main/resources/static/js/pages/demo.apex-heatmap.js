...
var options = {
    ...
    colors: ["#727cf5"],
    series: [{name: "Metric 1", data: generateData(20, {min: 0, max: 90})}, {
        name: "Metric 2",
...
options = {
    ...
    plotOptions: {
        heatmap: {
            shadeIntensity: .5,
            colorScale: {
                ranges: [{from: -30, to: 5, name: "Low", color: "#0acf97"}, {
                    from: 6,
                    to: 20,
                    name: "Medium",
                    color: "#39afd1"
                }, {from: 21, to: 45, name: "High", color: "#ffbc00"}, {
                    from: 46,
                    to: 55,
                    name: "Extreme",
                    color: "#fa5c7c"
...
options = {
    ...
    plotOptions: {
        heatmap: {
            radius: 30,
            enableShades: !1,
            colorScale: {ranges: [{from: 0, to: 50, color: "#39afd1"}, {from: 51, to: 100, color: "#0acf97"}]}
        }
    },
