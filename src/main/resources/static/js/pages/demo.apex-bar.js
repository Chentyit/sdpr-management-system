...
options = {
    chart: {
        ...
        stacked: !0,
        toolbar: {show: !1},
        shadow: {enabled: !0, blur: 1, opacity: .5}
    },
    ...
    series: [{name: "Marine Sprite", data: [44, 55, 41, 37, 22, 43, 21]}, {
        name: "Striking Calf",
        data: [53, 32, 33, 52, 13, 43, 32]
    }, {name: "Tank Picture", data: [12, 17, 11, 9, 15, 11, 20]}, {name: "Bucket Slope", data: [9, 7, 5, 8, 6, 9, 4]}],
    xaxis: {categories: [2008, 2009, 2010, 2011, 2012, 2013, 2014]},
...
options = {
    ...
    fill: {type: "image", opacity: .87, image: {src: ["assets/images/small/small-4.jpg"], width: 466, height: 406}}
};
...
options = {
    ...
    dataLabels: {
        enabled: !0, textAnchor: "start", style: {colors: ["#fff"]}, formatter: function (e, t) {
