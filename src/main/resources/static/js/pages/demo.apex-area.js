...
document.querySelector("#one_month").addEventListener("click", function (e) {
    ...
    resetCssClasses(e), chart.updateOptions({xaxis: {min: void 0, max: void 0}})
...
options = {
    ...
    fill: {opacity: .5, gradient: {enabled: !1}},
...
var optionsarea2 = {
    chart: {id: "chartyear", type: "area", height: 160, toolbar: {show: !1, autoSelected: "pan"}},
    colors: ["#FF7F00"],
    stroke: {width: 0, curve: "smooth"},
    dataLabels: {enabled: !1},
    fill: {opacity: 1, type: "solid"},
    series: [{name: "commits", data: githubdata.series}],
    yaxis: {tickAmount: 3, labels: {show: !1}},
    xaxis: {type: "datetime"}
...
options = {
    chart: {
        ...
        selection: {
            enabled: !0,
            xaxis: {min: new Date("05 Jan 2014").getTime(), max: new Date("04 Jan 2015").getTime()}
        }
    },
    colors: ["#7BD39A"],
    dataLabels: {enabled: !1},
...
options = {
    chart: {
        height: 422, type: "area", stacked: !0, events: {
    ...
    series: [{
        ...
        name: "North",
        data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, {min: 10, max: 20})
...
function generateDayWiseTimeSeries(e, t, a) {
    for (var r = 0, o = []; r < t;) {
        var i = e, n = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
...
options = {
    ...
    dataLabels: {enabled: !1},
    series: [{name: "PRODUCT A", data: dataSet[0]}, {name: "PRODUCT B", data: dataSet[1]}, {
        name: "PRODUCT C",
        data: dataSet[2]
    }],
